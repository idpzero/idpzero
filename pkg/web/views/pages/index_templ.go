...
func index(model models.IndexModel) templ.Component {
	return templruntime.GeneratedTemplate(func(templ_7745c5c3_Input templruntime.GeneratedComponentInput) (templ_7745c5c3_Err error) {
		...
		for _, url := range model.Urls {
			...
			if templ_7745c5c3_Err != nil {
				return templ.Error{Err: templ_7745c5c3_Err, FileName: `pkg/web/views/pages/index.templ`, Line: 35, Col: 36}
			}
			...
			if templ_7745c5c3_Err != nil {
				return templ.Error{Err: templ_7745c5c3_Err, FileName: `pkg/web/views/pages/index.templ`, Line: 36, Col: 77}
			}
		...
		for _, client := range model.Clients {
			...
			templ_7745c5c3_Var6, templ_7745c5c3_Err = templ.JoinStringErrs(client.ClientID)
			if templ_7745c5c3_Err != nil {
				return templ.Error{Err: templ_7745c5c3_Err, FileName: `pkg/web/views/pages/index.templ`, Line: 60, Col: 36}
			}
			...
			templ_7745c5c3_Var7, templ_7745c5c3_Err = templ.JoinStringErrs(client.ApplicationType)
			if templ_7745c5c3_Err != nil {
				return templ.Error{Err: templ_7745c5c3_Err, FileName: `pkg/web/views/pages/index.templ`, Line: 61, Col: 43}
			}
			...
			for _, gt := range client.GrantTypes {
				...
				templ_7745c5c3_Var8, templ_7745c5c3_Err = templ.JoinStringErrs(gt)
				if templ_7745c5c3_Err != nil {
					return templ.Error{Err: templ_7745c5c3_Err, FileName: `pkg/web/views/pages/index.templ`, Line: 64, Col: 33}
				}
			...
			for _, ruri := range client.RedirectURIs {
				...
				templ_7745c5c3_Var9, templ_7745c5c3_Err = templ.JoinStringErrs(ruri)
				if templ_7745c5c3_Err != nil {
					return templ.Error{Err: templ_7745c5c3_Err, FileName: `pkg/web/views/pages/index.templ`, Line: 69, Col: 35}
				}
